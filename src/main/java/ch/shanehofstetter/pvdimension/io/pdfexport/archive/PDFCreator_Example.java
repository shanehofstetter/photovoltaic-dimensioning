...
public class PDFCreator_Example {
    ...
    public static void main(String[] args) {
        try {
            ...
            OutputStream file = new FileOutputStream(new File(userHomeFolder, "Desktop/PVDimension_LAB_" + new Date().getTime() + ".pdf"));
    ...
    private static void addMetaData(Document document) {
        document.addTitle(ApplicationInfo.APPLICATION_TITLE_SHORT + " Report");
